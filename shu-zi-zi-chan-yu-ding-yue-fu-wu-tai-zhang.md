---
description: 按分类整理的数字资产、VPS、订阅服务、软件许可证和域名台账
icon: table-list
layout:
  width: wide
---
...
> 数据来源：`/Users/zcp/codes/digital-assets/assets.md`。更新时间：2026-06-29 09:24:54 CST。
...
| IN CloudVPS #5 ( FAT32 Special ) | hostdzire | 27.74 | € | 年付 | 2026/07/30 | 否 | [打开](https://hostdzire.com/billing/clientarea.php?action=productdetails&id=107728) | 16C32G |
...
| 服务名称 | 服务商 | 金额 | 币种 | 周期 | 下次扣费日期 | 自动续费 | 管理地址 | 备注 |
|---|---|---|---|---|---|---|---|---|
| AppleOne | Apple | 195 | ₹ | 月付 | 2026/06/29 | 是 | [打开](https://account.apple.com/subscriptions) |  |

## 软件 / 许可证

| 服务名称 | 服务商 | 金额 | 币种 | 周期 | 下次扣费日期 | 自动续费 | 管理地址 | 备注 |
|---|---|---|---|---|---|---|---|---|
| Proton Pass | proton | 59.88 | $ | 年付 | 2026/11/16 | 否 | [打开](https://account.proton.me/u/3/pass/dashboard) | 不续订，过期后自动从台账删除（计划：2026/11/17） |
| microsoft family | microsoft | 288 | ₺ | 年付 | 2027/01/01 | 否 | [打开](https://account.microsoft.com/) |  |
| Termius Pro | microsoft | 85 | ₺ | 年付 | 2027/06/01 | 是 | [打开](https://account.microsoft.com/) |  |
...
- 自动续费为“是”的条目，到期当天按台账规则提醒并顺延。
- 自动续费为“否”的条目，到期前提醒续费或清理决策。
- 金额保留原始币种；月度报告中再统一折算为人民币。
- 管理地址使用“打开”链接显示，便于阅读。
